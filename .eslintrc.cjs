module.exports = {
  ...
  plugins: ['unused-imports', 'prefer-arrow', 'sort-exports', 'arca'],
  extends: [
    'eslint:recommended',
  ...
  overrides: [
    {
      files: [
        './**/{__mocks__,__tests__}/**/*.?(c|m)[jt]s?(x)',
    ...
    },
    {
      ...
      rules: {
         ...
         * typescript eslint
         */
        // start already checked by Typescript
        'getter-return': 'off',
        'no-dupe-args': 'off',
        'no-dupe-keys': 'off',
        'no-unreachable': 'off',
        ...
        // end already checked by Typescript
